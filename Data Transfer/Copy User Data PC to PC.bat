...
set logfile=/log:"C:\Users\%USERNAME%\Transfer Logs\%name%\Scans Transfer from %oldpc% to %newpc%.log" /tee
...
set logfile=/log:"C:\Users\%USERNAME%\Transfer Logs\%name%\Delorme Transfer from %oldpc% to %newpc%.log" /tee
