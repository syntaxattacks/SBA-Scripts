...
set destination=\\%PC%\c$\Users\%name%
set source=\\fl1hdnas1\workstationbackups$\%name%\
set options=/s /is
...
set destination=\\%PC%\c$\Scans
set source=\\fl1hdnas1\workstationbackups$\%name%\Scans\
...
set destination=/log:"C:\Users\%USERNAME%\Backup Logs\%name%\Delorme Backup from %PC%.log" /tee
set source=\\fl1hdnas1\workstationbackups$\%name%\Delorme\
robocopy  %source% %destination% %options% %triggers% %logfile%
